...
config :ratatoskr,
  ...
  max_subscribers_per_topic: System.get_env("RATATOSKR_MAX_SUBSCRIBERS", "1000") |> String.to_integer(),
  message_timeout_ms: System.get_env("RATATOSKR_MESSAGE_TIMEOUT_MS", "30000") |> String.to_integer()